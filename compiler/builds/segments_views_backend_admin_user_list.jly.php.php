    ...
    <div class="card">
      <div class="card-body">
        <div class="row">
          ...
          <div class="col">
            <a class="btn btn-md btn-primary float-right" href="<?php echo route('admin.users.create'); ?>">
              Add User
            </a>
          </div>
        </div>
          ...
          <tbody>
            ...
            <?php if($totalUsers > 0) { ?>
              ...
              <tr>
                ...
                <td><?php echo formatPhoneNumber($user->contact_number) ?? 'N/A'; ?></td>
                <td><?php echo date('M d, Y H:i', strtotime($user->created_at)); ?></td>
                <td><?php echo $user->expiration_date != '' ? date('M d, Y', strtotime($user->expiration_date)) : ''; ?></td>
                <td>
                  <a href="<?php echo url('admin/users/view/'.$user->id); ?>" class="btn btn-sm btn-success">
                    <span><i class="ti-eye"></i></span>
                  </a>
                  <a href="<?php echo url('admin/users/edit/'.$user->id); ?>" class="btn btn-sm btn-info">
