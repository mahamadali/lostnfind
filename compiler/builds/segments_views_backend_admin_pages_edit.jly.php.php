...
<?php } ?>
    ...
    <div class="card-body">
      <form method="post" action="<?php echo route('admin.pages.update'); ?>">
        ...
        <div class="row">
          <div class="col">
            <div class="form-group">
              ...
              <textarea class="form-control" name="description" id="description" cols="5" rows="5"><?php echo $page->description; ?></textarea>
            </div>
          </div>
        </div>
