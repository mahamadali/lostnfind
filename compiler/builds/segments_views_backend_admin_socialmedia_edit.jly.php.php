...
<?php } ?>
    ...
    <div class="card-body">
      <form method="post" action="<?php echo route('admin.socialmedia.update'); ?>">
        <input type="hidden" name="id" value="<?php echo $socialmedia->id; ?>" />
        <div class="row">
          <div class="col">
            <div class="form-group">
              <label>Title</label>
              <input type="text" class="form-control" name="title" value="<?php echo $socialmedia->title; ?>" />
            </div>
          </div>
          ...
          <div class="col">
            <div class="form-group">
              <label>Icon</label>
              <input type="text" class="form-control" name="icon" value="<?php echo htmlentities($socialmedia->icon); ?>" />
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col">
            <div class="form-group">
              <label>Url</label>
              <input type="text" class="form-control" name="url" value="<?php echo $socialmedia->url; ?>" />
            </div>
          </div>
        </div>
