...
<?php } ?>
    ...
    <div class="card-body">
      <form method="post" action="<?php echo route('user.items.update', ['item' => $item->id]); ?>" id="create-item-form" enctype="multipart/form-data">
        <div class="row">
          <div class="col">
            <div class="form-group">
              ...
              <select name="category_id" class="form-control" required>
                ...
                <option value="<?php echo $category->id; ?>" <?php echo $item->category->id == $category->id ? 'selected' : ''; ?>><?php echo $category->title; ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
          <div class="col">
            <div class="form-group">
              <label>Name</label>
              <input type="text" name="name" class="form-control" value="<?php echo $item->name; ?>" require/>
            </div>
          </div>
        </div>
        <div class="row">
...
var myDropzoneNewCollection = new Dropzone(".upload_item_images", {
    ...
    myDropzoneNewCollection.on("successmultiple", function(multiple,xhr) {
        window.location.href='<?php echo url("user/items"); ?>';
    });
