<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    @if (auth()->role->name == 'admin'):
      ...
      <li class="nav-item {{ (Bones\Str::contains(request()->currentPage(), '/admin/tags/')) ? 'active' : '' }}">
        <a class="nav-link" data-toggle="collapse" href="#user_tags" aria-expanded="false" aria-controls="user_tags">
          <i class="ti-list menu-icon"></i>
          <span class="menu-title">Tags</span>
          <i class="menu-arrow"></i>
        </a>
        <div class="collapse {{ (Bones\Str::contains(request()->currentPage(), '/admin/tags/')) ? 'show' : '' }}" id="user_tags">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{ route('admin.tags.create') }}"> Add </a></li>
            <li class="nav-item"> <a class="nav-link" href="{{ route('admin.tags.list') }}"> Tags </a></li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item {{ (Bones\Str::contains(request()->currentPage(), '/admin/advertise/')) ? 'active' : '' }}">
        ...
        <div class="collapse {{ (Bones\Str::contains(request()->currentPage(), '/admin/advertise/')) ? 'show' : '' }}" id="advertise">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{ route('admin.advertise.create') }}"> Add </a></li>
            <li class="nav-item"> <a class="nav-link" href="{{ route('admin.advertise.list') }}"> Adveritse </a></li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item {{ (request()->currentPage() == '/admin/messagesetting/list') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('admin.messagesetting.list') }}">
          <i class="ti-email menu-icon"></i>
