    ...
    <section id="features" class="features">
      <div class="container">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          ...
          <div class="col-md-5">
            <img src="{{ url('assets/frontend/img/features-1.jpg') }}" class="img-fluid" alt="">
          </div>
          <div class="col-md-7">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-5 order-1 order-md-2">
            <img src="{{ url('assets/frontend/img/features-2.jpg') }}" class="img-fluid" alt="">
          </div>
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-5">
            <img src="{{ url('assets/frontend/img/features-3.jpg') }}" class="img-fluid" alt="">
          </div>
          <div class="col-md-7">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-5 order-1 order-md-2">
            <img src="{{ url('assets/frontend/img/features-4.jpg') }}" class="img-fluid" alt="">
          </div>
          <div class="col-md-7 order-2 order-md-1">
