	...
	<tr>
		<td class="pad">
			<div class="alignment" align="center">
				<p style="margin: 0;">Below is your Tag ID to create an item.</p><br>
				<a href="Javascript:void(0);" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#3c9986;border-radius:4px;width:auto;border-top:1px solid #3c9986;font-weight:400;border-right:1px solid #3c9986;border-bottom:1px solid #3c9986;border-left:1px solid #3c9986;padding-top:5px;padding-bottom:5px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:14px;display:inline-block;letter-spacing:normal;"><span dir="ltr" style="word-break: break-word; line-height: 28px;"><strong>{{ $tag->tag_number }}</strong></span></span></a>
			</div>
		</td>
	</tr>
</table>
	...
	<tr>
		<td class="pad">
			<div class="alignment" align="center">
				...
				<a href="{{ route('signup', ['plan_request' => $purchasePlanRequest->id]) }}" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#3c9986;border-radius:4px;width:auto;border-top:1px solid #3c9986;font-weight:400;border-right:1px solid #3c9986;border-bottom:1px solid #3c9986;border-left:1px solid #3c9986;padding-top:5px;padding-bottom:5px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:14px;display:inline-block;letter-spacing:normal;"><span dir="ltr" style="word-break: break-word; line-height: 28px;"><strong>Click here to Activate Tag {{ $tag->tag_number }}</strong></span></span></a>
