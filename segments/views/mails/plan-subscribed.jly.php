	...
	<tr>
		<td class="pad">
			<div style="color:#000000;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:18px;">
				...
				<p style="margin: 0;">Congratulations! You have successfully purchased <b>{{ $purchasePlanRequest->plan()->first()->title }}</b> for <b>{{ $purchasePlanRequest->plan()->first()->days }}</b> Days with {{ $purchasePlanRequest->plan()->first()->price }} USD</p>
			</div>
		</td>
	</tr>
</table>
